        ...
        <div class="container">
           <!-- <div class="plugins-tips">
            ...
            <div class="plugins-tips">
                <p>添加个人事务</p>
                <br>
                <el-button type="primary" icon="el-icon-time" @click="visible = true;">点击添加</el-button>
            </div>
            <el-dialog v-dialogDrag title="添加事务" center :visible.sync="visible" width="30%">
                <el-input v-model="todothing" placeholder="todothing">
                </el-input>
...
<script>
    ...
    export default {
        ...
        methods: {
            removeHandle(event){
                console.log(event);
                this.$message.success(`当前${event.item.id} `);
